      ...
      <header class="leap-exec-bar">
         <div class="leap-exec-inner">
            ...
            <div style="display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
               ...
               <div class="growth-badge">DAX</div>
            </div>
         </div>
      </header>
            ...
            <div class="stack right-rail">
               <section class="dossier-card business-reading-card">
                  ...
                  <div class="semantic-grid">
                     <div class="semantic-item">
                        ...
                        <div style="font-size:14px; line-height:1.6;">SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;OEE %&quot; in the scanned source.</div>
                     </div>
                     <div class="semantic-item">
               ...
               <section class="dossier-card system-identifier-card">
                  ...
                  <div class="action-row">
                     ...
                     <a href="vscode://file/Users/meshaalmouawad/AI-Powered_KPI_Extractor_Interactive_Bluebook_Generator/sample_project/ax_kpi.dax:2" class="action-btn">VS Code</a>
                     <a href="pycharm://open?file=/Users/meshaalmouawad/AI-Powered_KPI_Extractor_Interactive_Bluebook_Generator/sample_project/ax_kpi.dax&line=2" class="action-btn">PyCharm</a>
                     
                     <a href="/edit?kpi=OEE%20%25" target="_blank" class="action-btn action-btn-primary">Edit Dossier</a>
               ...
               <section class="dossier-card">
                  ...
                  <div class="formula-panel">
                     ...
                     <div class="leap-business-formula-math" data-raw-formula="(Availability * Performance * Quality) * 100"><span class="leap-formula-fallback">(Availability * Performance * Quality) * 100</span></div>
                     ...
                     <div class="leap-annotated-formula-wrapper leap-annotated-equation" data-perspective="business">
                        ...
                        <div class="leap-formula-node">
                           <span class="leap-math-lbl" data-biz="Availability" data-dev="COLUMN: Availability">Availability</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">Availability</span>
                        </div>
                        ...
                        <div class="leap-formula-node">
                           <span class="leap-math-lbl" data-biz="Performance" data-dev="COLUMN: Performance">Performance</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">Performance</span>
                        </div>
                        ...
                        <div class="leap-formula-node">
                           <span class="leap-math-lbl" data-biz="Quality" data-dev="COLUMN: Quality">Quality</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">Quality</span>
                        </div>
                     ...
                     <div class="leap-code-lineage" hidden><div class="leap-code-lineage-title">Developer Lineage Breakdown</div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">1 | -- KPI: Overall Equipment Effectiveness (OEE)</div><div class="leap-code-lineage-role">KPI marker: tells LEAP this nearby code defines or documents a KPI.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">2 | DEFINE MEASURE &#x27;KPI&#x27;[OEE %] =</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">3 | VAR Availability = 0.95</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">4 | VAR Performance  = 0.98</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">5 | VAR Quality      = 0.99</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">6 | RETURN (Availability * Performance * Quality) * 100</div><div class="leap-code-lineage-role">Calculation expression: combines source variables used by the formal formula.</div></div></div>
                     
                     <details class="evidence-inline">
                        <summary>Code Evidence</summary>
                        <pre class="font-mono">   1 | -- KPI: Overall Equipment Effectiveness (OEE)
   2 | DEFINE MEASURE &#x27;KPI&#x27;[OEE %] =
   3 | VAR Availability = 0.95
   4 | VAR Performance  = 0.98
   5 | VAR Quality      = 0.99</pre>
                     </details>
                  </div>
               ...
               <section class="dossier-card">
                  ...
                  <div class="literate-step">
                     ...
                     <div style="font-size:14px; line-height:1.6;">SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;OEE %&quot; in the scanned source. LEAP frames this as an operational evidence signal for operations decision-making.</div>
                  </div>
                  <div class="literate-step">
                     <div class="micro-label">Verified Logic Mapping (The Recipe)</div>
                     <div style="font-size:14px; line-height:1.6;"><ol><li>First, LEAP anchors the KPI definition to ax_kpi.dax and classifies the implementation as DAX evidence.</li><li>Second, it translates the approved business expression (UNDETERMINED: No approved business formula statement found in source comments.) into the formal MathJax formula shown above.</li><li>Finally, it preserves the executable code context and code fingerprint so future changes to the KPI logic can be detected.</li></ol></div>
                  </div>
                  <div class="literate-step">
                     <div class="micro-label">Logic Safeguards & Validations (The Answers)</div>
                     <div style="font-size:14px; line-height:1.6;"><div class="walkthrough-proof-list"><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Source Traceability:</strong> Executable evidence is locked to ax_kpi.dax at line 2.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Formula Consistency Check:</strong> The business formula and source evidence share compatible calculation structure based on LEAP&#x27;s static comparison.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Change Detection:</strong> Code Fingerprint 58d454ae36 records the current implementation so drift can be detected after regeneration.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>RACI Accountability:</strong> Operations Data Owner is assigned as accountable owner for rule confirmation and escalation.</div></div></div></div>
                  </div>
                  <div class="literate-step">
               ...
               <section class="dossier-card">
                  ...
                  <div class="dependency-row">
                     ...
                     <div style="flex:1;">
                        <div style="display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap;">
                           <span class="font-mono" style="font-size:13px;">ax_kpi.dax</span>
                           <span class="source-chip" style="color:var(--warning);">SOURCE</span>
                        </div>
                        <p style="margin:4px 0 0; color:var(--slate-muted); font-size:12px;">Line 2 • Dax Measure</p>
                     </div>
                  </div>
                  <div class="dependency-row">
                     <div class="tiny-dot"></div>
               ...
               <section class="dossier-card">
                  ...
                  <div style="display:grid; gap:16px; font-size:14px;">
                     <div>
                        ...
                        <div><p>SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;OEE %&quot; in the scanned source. No business meaning was inferred beyond the source text.</p></div>
                     </div>
                     <div>
            ...
            <aside class="leap-metadata-sidebar">
               <div class="sidebar-card status-card">
                  ...
                  <div class="sidebar-meta-row"><span class="meta-label">Fingerprint:</span><span class="meta-value code-font">58d454ae</span></div>
               </div>
               ...
               <div class="sidebar-card compact-card">
                  ...
                  <div class="sidebar-meta-row"><span class="meta-label">Type:</span><span class="meta-value">DAX + Static Scan</span></div>
...
.. raw:: html
   ...
   <div class="formula-panel" style="background-color: #1E1E2E !important; color: #CDD6F4 !important;">
      <pre class="font-mono" style="background-color: transparent !important; color: #CDD6F4 !important;">-- KPI: Overall Equipment Effectiveness (OEE)
DEFINE MEASURE &#39;KPI&#39;[OEE %] =
VAR Availability = 0.95
VAR Performance  = 0.98
VAR Quality      = 0.99
RETURN (Availability * Performance * Quality) * 100</pre>
   </div>
