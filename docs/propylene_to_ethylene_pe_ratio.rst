...
.. raw:: html
   ...
   <table class="kpi-table">
      <tbody>
         <tr>
            <td>Description</td>
            <td><ul><li>The Propylene to Ethylene (P/E) Ratio is a key performance indicator that measures the relative production levels of propylene compared to ethylene in a petrochemical plant</li><li>This ratio is essential for understanding the product mix and aligning production with market demand</li></ul></td>
         </tr>
         <tr>
            <td>Objective</td>
            <td><ul><li>The objective of monitoring the P/E Ratio is to optimize the production process to maximize profitability while meeting market requirements for both propylene and ethylene</li></ul></td>
         </tr>
         <tr>
            <td>Formula</td>
            <td>
               <p>The P/E Ratio is calculated by dividing the total amount of propylene produced by the total amount of ethylene produced.</p>
         ...
         <tr>
            <td>Used in KPI(s)</td>
            <td><ul><li>This KPI is used in various operational assessments and strategic planning to ensure that production aligns with market trends and profitability goals</li></ul></td>
         </tr>
         <tr>
            <td>Input Measure</td>
            <td><ul><li>The inputs for calculating the P/E Ratio are the total tons of propylene produced and the total tons of ethylene produced</li></ul></td>
         </tr>
         <tr>
         ...
         <tr>
            ...
            <td>The data for this KPI is typically sourced from production logs and operational databases within the petrochemical plant.</td>
         </tr>
         <tr>
            <td>Comments</td>
            <td>A higher P/E Ratio may indicate a favorable market for propylene, while a lower ratio could suggest a need to adjust production strategies to meet demand for ethylene.</td>
         </tr>
      </tbody>
   </table>
