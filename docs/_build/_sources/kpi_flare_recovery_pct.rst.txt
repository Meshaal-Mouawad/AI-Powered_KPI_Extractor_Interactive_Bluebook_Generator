         ...
         <div class="leap-exec-inner">
            ...
            <div style="display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
               <div style="display:flex; align-items:center; gap:8px;">
                  ...
                  <span style="font-size:14px; font-weight:600; color:var(--success);">85%</span>
               </div>
               <div class="growth-badge">HANA</div>
            </div>
         </div>
      </header>
         ...
         <div class="dossier-grid">
            <div class="stack right-rail">
               <section class="dossier-card business-reading-card">
                  ...
                  <div class="semantic-grid">
                     <div class="semantic-item">
                        ...
                        <div style="font-size:14px; line-height:1.6;">SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;kpi flare recovery pct&quot; in the scanned source.</div>
                     </div>
                     <div class="semantic-item">
               ...
               <section class="dossier-card system-identifier-card">
                  ...
                  <div class="action-row">
                     ...
                     <a href="vscode://file/Users/meshaalmouawad/AI-Powered_KPI_Extractor_Interactive_Bluebook_Generator/sample_project/ana_kpi.hdbview:1" class="action-btn">VS Code</a>
                     <a href="pycharm://open?file=/Users/meshaalmouawad/AI-Powered_KPI_Extractor_Interactive_Bluebook_Generator/sample_project/ana_kpi.hdbview&line=1" class="action-btn">PyCharm</a>
                     
                     <a href="/edit?kpi=kpi%20flare%20recovery%20pct" target="_blank" class="action-btn action-btn-primary">Edit Dossier</a>
               ...
               <section class="dossier-card">
                  ...
                  <div class="formula-panel">
                     ...
                     <div class="leap-business-formula-math" data-raw-formula="(recovered_gas_m3 / total_gas_m3) * 100"><span class="leap-formula-fallback">(recovered_gas_m3 / total_gas_m3) * 100</span></div>
                     ...
                     <div class="leap-annotated-formula-wrapper leap-annotated-equation" data-perspective="business">
                        ...
                        <div class="leap-formula-node">
                           <span class="leap-math-lbl long-line" data-biz="Recovered Gas M3" data-dev="COLUMN: recovered_gas_m3">Recovered Gas M3</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">recovered_gas_m3</span>
                        </div>
                        ...
                        <div class="leap-formula-node">
                           <span class="leap-math-lbl" data-biz="Total Gas M3" data-dev="COLUMN: total_gas_m3">Total Gas M3</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">total_gas_m3</span>
                        </div>
                     ...
                     <div class="leap-code-lineage" hidden><div class="leap-code-lineage-title">Developer Lineage Breakdown</div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">1 | SELECT (recovered_gas_m3 / NULLIF(total_gas_m3,0)) * 100 AS kpi_flare_recovery_pct</div><div class="leap-code-lineage-role">Query entry point: starts the data-selection logic used to calculate the KPI.</div></div></div>
                     
                     <details class="evidence-inline">
                        <summary>Code Evidence</summary>
                        <pre class="font-mono">   1 | SELECT (recovered_gas_m3 / NULLIF(total_gas_m3,0)) * 100 AS kpi_flare_recovery_pct</pre>
                     </details>
                  </div>
               ...
               <section class="dossier-card">
                  ...
                  <div class="dependency-row">
                     ...
                     <div style="flex:1;">
                        <div style="display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap;">
                           <span class="font-mono" style="font-size:13px;">ana_kpi.hdbview</span>
                           <span class="source-chip" style="color:var(--warning);">SOURCE</span>
                        </div>
                        <p style="margin:4px 0 0; color:var(--slate-muted); font-size:12px;">Line 1 • Hana Json</p>
                     </div>
                  </div>
                  <div class="dependency-row">
                     <div class="tiny-dot"></div>
               ...
               <section class="dossier-card">
                  ...
                  <div style="display:grid; gap:16px; font-size:14px;">
                     <div>
                        ...
                        <div><p>SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;kpi flare recovery pct&quot; in the scanned source. No business meaning was inferred beyond the source text.</p></div>
                     </div>
                     <div>
            ...
            <aside class="leap-metadata-sidebar">
               <div class="sidebar-card status-card">
                  ...
                  <div class="sidebar-meta-row"><span class="meta-label">Confidence:</span><span class="meta-value">85%</span></div>
                  <div class="sidebar-meta-row"><span class="meta-label">Fingerprint:</span><span class="meta-value code-font">26e9250a</span></div>
               </div>
               ...
               <div class="sidebar-card review-queue-card" id="governance-review-note">
                  ...
                  <textarea class="review-queue-text" readonly>Please review this LEAP KPI evidence file.&#10;&#10;KPI: kpi flare recovery pct&#10;KPI ID: KPI-26E9250AF8&#10;Accountable owner: HSE Data Owner&#10;Consulted SME: Environmental Compliance Team&#10;Source: ana_kpi.hdbview&#10;Line: 1&#10;&#10;Review questions:&#10;- Does the business meaning match how the KPI is used?&#10;- Does the formula reflect the approved business rule?&#10;- Are the source fields, filters, and reporting period correct?&#10;- Should this KPI be marked Validated or Needs Review?</textarea>
                  <a id="open-email-draft-btn" class="sidebar-btn btn-secondary" href="mailto:?subject=LEAP+KPI+review+requested%3A+kpi+flare+recovery+pct&body=Please+review+this+LEAP+KPI+evidence+file.%0A%0AKPI%3A+kpi+flare+recovery+pct%0AKPI+ID%3A+KPI-26E9250AF8%0AAccountable+owner%3A+HSE+Data+Owner%0AConsulted+SME%3A+Environmental+Compliance+Team%0ASource%3A+ana_kpi.hdbview%0ALine%3A+1%0A%0AReview+questions%3A%0A-+Does+the+business+meaning+match+how+the+KPI+is+used%3F%0A-+Does+the+formula+reflect+the+approved+business+rule%3F%0A-+Are+the+source+fields%2C+filters%2C+and+reporting+period+correct%3F%0A-+Should+this+KPI+be+marked+Validated+or+Needs+Review%3F">Open Email Draft</a>
               ...
               <div class="sidebar-card compact-card">
                  ...
                  <div class="sidebar-meta-row"><span class="meta-label">Type:</span><span class="meta-value">HANA + Static Scan</span></div>
...
.. raw:: html
   ...
   <div class="formula-panel" style="background-color: #1E1E2E !important; color: #CDD6F4 !important;">
      <pre class="font-mono" style="background-color: transparent !important; color: #CDD6F4 !important;">SELECT (recovered_gas_m3 / NULLIF(total_gas_m3,0)) * 100 AS kpi_flare_recovery_pct</pre>
   </div>
