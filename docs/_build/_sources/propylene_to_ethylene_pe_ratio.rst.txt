            ...
            <div class="stack right-rail">
               <section class="dossier-card business-reading-card">
                  ...
                  <div class="semantic-grid">
                     <div class="semantic-item">
                        ...
                        <div style="font-size:14px; line-height:1.6;">SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;Propylene to Ethylene (P/E) Ratio&quot; in the scanned source.</div>
                     </div>
                     <div class="semantic-item">
               ...
               <section class="dossier-card system-identifier-card">
                  ...
                  <div class="action-row">
                     ...
                     <a href="vscode://file/Users/meshaalmouawad/AI-Powered_KPI_Extractor_Interactive_Bluebook_Generator/sample_project/dotnet_kpi.cs:1" class="action-btn">VS Code</a>
                     <a href="pycharm://open?file=/Users/meshaalmouawad/AI-Powered_KPI_Extractor_Interactive_Bluebook_Generator/sample_project/dotnet_kpi.cs&line=1" class="action-btn">PyCharm</a>
                     
                     <a href="/edit?kpi=Propylene%20to%20Ethylene%20%28P/E%29%20Ratio" target="_blank" class="action-btn action-btn-primary">Edit Dossier</a>
               ...
               <section class="dossier-card">
                  ...
                  <div class="formula-panel">
                     ...
                     <div class="leap-business-formula-math" data-raw-formula="propyleneProducedTons / ethyleneProducedTons"><span class="leap-formula-fallback">propyleneProducedTons / ethyleneProducedTons</span></div>
                     ...
                     <div class="leap-annotated-formula-wrapper leap-annotated-equation" data-perspective="business">
                        ...
                        <div class="leap-formula-node">
                           <span class="leap-math-lbl long-line" data-biz="Propylene Produced Tons" data-dev="COLUMN: propyleneProducedTons">Propylene Produced Tons</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">propyleneProducedTons</span>
                        </div>
                        ...
                        <div class="leap-formula-node">
                           <span class="leap-math-lbl long-line" data-biz="Ethylene Produced Tons" data-dev="COLUMN: ethyleneProducedTons">Ethylene Produced Tons</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">ethyleneProducedTons</span>
                        </div>
                        
                     </div>
                     
                     <div class="leap-code-lineage" hidden><div class="leap-code-lineage-title">Developer Lineage Breakdown</div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">1 | // KPI: Propylene to Ethylene (P/E) Ratio</div><div class="leap-code-lineage-role">KPI marker: tells LEAP this nearby code defines or documents a KPI.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">2 | public static class KpiDemo</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">3 | {</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">4 | public static double ComputePERatio(double propyleneProducedTons, double ethyleneProducedTons)</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">5 | {</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">6 | if (ethyleneProducedTons == 0) return 0.0;</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">7 | return propyleneProducedTons / ethyleneProducedTons;</div><div class="leap-code-lineage-role">Calculation expression: combines source variables used by the formal formula.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">8 | }</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">9 | }</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div></div>
                     
                     <details class="evidence-inline">
                        <summary>Code Evidence</summary>
                        <pre class="font-mono">   1 | // KPI: Propylene to Ethylene (P/E) Ratio
   2 | public static class KpiDemo
   3 | {
   4 |     public static double ComputePERatio(double propyleneProducedTons, double ethyleneProducedTons)
   5 |     {</pre>
                     </details>
                  </div>
               ...
               <section class="dossier-card">
                  ...
                  <div class="literate-step">
                     ...
                     <div style="font-size:14px; line-height:1.6;">SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;Propylene to Ethylene (P/E) Ratio&quot; in the scanned source. LEAP frames this as an operational evidence signal for enterprise decision-making.</div>
                  </div>
                  <div class="literate-step">
                     <div class="micro-label">Verified Logic Mapping (The Recipe)</div>
                     <div style="font-size:14px; line-height:1.6;"><ol><li>First, LEAP anchors the KPI definition to dotnet_kpi.cs and classifies the implementation as CSHARP evidence.</li><li>Second, it translates the approved business expression (UNDETERMINED: No approved business formula statement found in source comments.) into the formal MathJax formula shown above.</li><li>Finally, it preserves the executable code context and code fingerprint so future changes to the KPI logic can be detected.</li></ol></div>
                  </div>
                  <div class="literate-step">
                     <div class="micro-label">Logic Safeguards & Validations (The Answers)</div>
                     <div style="font-size:14px; line-height:1.6;"><div class="walkthrough-proof-list"><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Zero-Division Guard:</strong> Source logic checks for a zero denominator before returning the KPI value.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Formula Consistency Check:</strong> The business formula and source evidence share compatible calculation structure based on LEAP&#x27;s static comparison.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Change Detection:</strong> Code Fingerprint 951831f74a records the current implementation so drift can be detected after regeneration.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>RACI Accountability:</strong> Enterprise Data Owner is assigned as accountable owner for rule confirmation and escalation.</div></div></div></div>
                  </div>
                  <div class="literate-step">
               ...
               <section class="dossier-card">
                  ...
                  <div class="dependency-row">
                     ...
                     <div style="flex:1;">
                        <div style="display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap;">
                           <span class="font-mono" style="font-size:13px;">dotnet_kpi.cs</span>
               ...
               <section class="dossier-card">
                  ...
                  <div style="display:grid; gap:16px; font-size:14px;">
                     <div>
                        ...
                        <div><p>SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;Propylene to Ethylene (P/E) Ratio&quot; in the scanned source. No business meaning was inferred beyond the source text.</p></div>
                     </div>
                     <div>
            ...
            <aside class="leap-metadata-sidebar">
               <div class="sidebar-card status-card">
                  ...
                  <div class="sidebar-meta-row"><span class="meta-label">Fingerprint:</span><span class="meta-value code-font">951831f7</span></div>
               </div>
...
.. raw:: html
   ...
   <div class="formula-panel" style="background-color: #1E1E2E !important; color: #CDD6F4 !important;">
      <pre class="font-mono" style="background-color: transparent !important; color: #CDD6F4 !important;">// KPI: Propylene to Ethylene (P/E) Ratio
