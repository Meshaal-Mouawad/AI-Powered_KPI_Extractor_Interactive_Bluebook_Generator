...
.. raw:: html
   ...
   <table class="kpi-table">
      <tbody>
         <tr>
            <td>Description</td>
            <td><ul><li>The Steam-to-Ethylene Ratio is a key performance indicator that measures the amount of steam used in relation to the production of ethylene</li><li>This ratio is crucial for assessing the efficiency of the steam cracking process in petrochemical production</li></ul></td>
         </tr>
         <tr>
            <td>Objective</td>
            <td><ul><li>The objective of monitoring the Steam-to-Ethylene Ratio is to optimize the steam usage in ethylene production</li><li>thereby enhancing operational efficiency and reducing costs associated with steam generation</li></ul></td>
         </tr>
         <tr>
            <td>Formula</td>
            <td>
               <p>The ratio is calculated by dividing the volume of steam by the volume of ethylene produced, ensuring that the ethylene value is not zero to avoid division errors.</p>
         ...
         <tr>
            <td>Used in KPI(s)</td>
            <td><ul><li>This KPI is used in various operational and efficiency KPIs related to steam cracking processes and overall ethylene production performance</li></ul></td>
         </tr>
         <tr>
            <td>Input Measure</td>
            <td><ul><li>The input measures for this KPI are the volumes of steam and ethylene produced during the cracking process</li></ul></td>
         </tr>
         <tr>
            <td>Unit of Measure</td>
            <td>The unit of measure for the Steam-to-Ethylene Ratio is dimensionless, as it represents a ratio of two volumetric quantities.</td>
         </tr>
         <tr>
            <td>Reporting Source</td>
            <td>The data for this KPI is typically sourced from production reports and operational data collected from steam cracking units.</td>
         </tr>
         <tr>
            <td>Comments</td>
            <td>A lower Steam-to-Ethylene Ratio indicates more efficient use of steam in the production of ethylene, while a higher ratio may suggest inefficiencies or excess steam consumption.</td>
         </tr>
      </tbody>
   </table>
