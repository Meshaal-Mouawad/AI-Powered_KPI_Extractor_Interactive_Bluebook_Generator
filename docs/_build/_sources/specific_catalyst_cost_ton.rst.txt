      ...
      <header class="leap-exec-bar">
         <div class="leap-exec-inner">
            ...
            <div style="display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
               ...
               <div class="growth-badge">TSQL</div>
            </div>
         </div>
      </header>
               ...
               <section class="dossier-card business-reading-card">
                  ...
                  <div class="semantic-grid">
                     <div class="semantic-item">
                        ...
                        <div style="font-size:14px; line-height:1.6;">SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;Specific Catalyst Cost ($/ton)&quot; in the scanned source.</div>
                     </div>
                     <div class="semantic-item">
                  ...
                  <div style="margin-top:16px; padding-top:14px; border-top:1px solid var(--slate-border);">
                     ...
                     <div style="font-size:14px; line-height:1.6;">If this KPI trends up: Usually signals a higher burden, risk, or exception volume that should be reviewed by the accountable owner. If it trends down: Usually signals lower burden or improved control, provided the data capture process has not changed. Owner check: What changed in source data, business process, or KPI logic that explains movement in Specific Catalyst Cost ($/ton)?</div>
                  </div>
               </section>

               <section class="dossier-card system-identifier-card">
                  <h3 class="leap-card-title" style="margin-bottom:16px;">System Identifier</h3>
                  <div class="card-row"><span class="label">KPI_ID:</span><span class="value font-mono">KPI-FC2AC68686</span></div>
                  <div class="card-row"><span class="label">Name:</span><span class="value">Specific Catalyst Cost ($/ton)</span></div>
                  <div class="card-row"><span class="label">Owner:</span><span class="value">Finance Data Owner</span></div>
                  ...
                  <div class="action-row">
                     ...
                     <a href="vscode://file/Users/meshaalmouawad/AI-Powered_KPI_Extractor_Interactive_Bluebook_Generator/sample_project/tsql_kpi.tsql:1" class="action-btn">VS Code</a>
                     <a href="pycharm://open?file=/Users/meshaalmouawad/AI-Powered_KPI_Extractor_Interactive_Bluebook_Generator/sample_project/tsql_kpi.tsql&line=1" class="action-btn">PyCharm</a>
                     
                     <a href="/edit?kpi=Specific%20Catalyst%20Cost%20%28%24/ton%29" target="_blank" class="action-btn action-btn-primary">Edit Dossier</a>
               ...
               <section class="dossier-card">
                  ...
                  <div class="formula-panel">
                     ...
                     <div class="leap-annotated-formula-wrapper leap-annotated-equation" data-perspective="business">
                        ...
                        <div class="leap-formula-node">
                           <span class="leap-math-lbl" data-biz="Catalyst Cost" data-dev="COLUMN: catalyst_cost">Catalyst Cost</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">catalyst_cost</span>
                        </div>
                        ...
                        <div class="leap-formula-node">
                           <span class="leap-math-lbl" data-biz="Product Tons" data-dev="COLUMN: product_tons">Product Tons</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">product_tons</span>
                        </div>
                        
                     </div>
                     
                     <div class="leap-code-lineage" hidden><div class="leap-code-lineage-title">Developer Lineage Breakdown</div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">1 | -- KPI: Specific Catalyst Cost ($/ton)</div><div class="leap-code-lineage-role">KPI marker: tells LEAP this nearby code defines or documents a KPI.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">2 | -- Formula: \mathrm{Catalyst\,Cost\,per\,Ton} = \frac{\mathrm{Catalyst\,Cost}}{\mathrm{Product\,Tons}}</div><div class="leap-code-lineage-role">Calculation hint: documents the business expression expected inside the KPI implementation.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">3 | -- T-SQL example KPI calculation</div><div class="leap-code-lineage-role">Calculation hint: documents the business expression expected inside the KPI implementation.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">4 | SELECT CAST(catalyst_cost / NULLIF(product_tons, 0) AS DECIMAL(18,6)) AS kpi_specific_catalyst_cost;</div><div class="leap-code-lineage-role">Query entry point: starts the data-selection logic used to calculate the KPI.</div></div></div>
                     
                     <details class="evidence-inline">
                        <summary>Code Evidence</summary>
                        <pre class="font-mono">   1 | -- KPI: Specific Catalyst Cost ($/ton)
   2 | -- Formula: \mathrm{Catalyst\,Cost\,per\,Ton} = \frac{\mathrm{Catalyst\,Cost}}{\mathrm{Product\,Tons}}
   3 | 
   4 | -- T-SQL example KPI calculation
   5 | SELECT CAST(catalyst_cost / NULLIF(product_tons, 0) AS DECIMAL(18,6)) AS kpi_specific_catalyst_cost;</pre>
                     </details>
                  </div>
               ...
               <section class="dossier-card">
                  ...
                  <div class="literate-step">
                     ...
                     <div style="font-size:14px; line-height:1.6;">SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;Specific Catalyst Cost ($/ton)&quot; in the scanned source. LEAP frames this as an operational evidence signal for finance decision-making.</div>
                  </div>
                  <div class="literate-step">
                     <div class="micro-label">Verified Logic Mapping (The Recipe)</div>
                     <div style="font-size:14px; line-height:1.6;"><ol><li>First, LEAP anchors the KPI definition to tsql_kpi.tsql and classifies the implementation as TSQL evidence.</li><li>Second, it translates the approved business expression (\mathrm{Catalyst\,Cost\,per\,Ton} = \frac{\mathrm{Catalyst\,Cost}}{\mathrm{Product\,Tons}}) into the formal MathJax formula shown above.</li><li>Finally, it preserves the executable code context and code fingerprint so future changes to the KPI logic can be detected.</li></ol></div>
                  </div>
                  <div class="literate-step">
                     <div class="micro-label">Logic Safeguards & Validations (The Answers)</div>
                     <div style="font-size:14px; line-height:1.6;"><div class="walkthrough-proof-list"><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Zero-Division Guard:</strong> Source logic uses NULLIF so denominator values of zero do not create invalid ratio calculations.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Formula Consistency Check:</strong> The business formula and source evidence share compatible calculation structure based on LEAP&#x27;s static comparison.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Change Detection:</strong> Code Fingerprint fc2ac68686 records the current implementation so drift can be detected after regeneration.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>RACI Accountability:</strong> Finance Data Owner is assigned as accountable owner for rule confirmation and escalation.</div></div></div></div>
                  </div>
                  <div class="literate-step">
                     <div class="micro-label">Executive Sign-off Alignment</div>
                     <div style="font-size:14px; line-height:1.6;">Business rules are aligned to inferred from KPI name: Financial KPI name. RACI Owner: Finance Data Owner. Consulted reviewer: Finance BI Team. Current status: Extracted for validation.</div>
                  </div>
               </section>
               ...
               <section class="dossier-card">
                  ...
                  <div class="dependency-row">
                     ...
                     <div style="flex:1;">
                        <div style="display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap;">
                           <span class="font-mono" style="font-size:13px;">tsql_kpi.tsql</span>
               ...
               <section class="dossier-card">
                  ...
                  <div style="display:grid; gap:16px; font-size:14px;">
                     <div>
                        ...
                        <div><p>SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;Specific Catalyst Cost ($/ton)&quot; in the scanned source. No business meaning was inferred beyond the source text.</p></div>
                     </div>
                     <div>
            ...
            <aside class="leap-metadata-sidebar">
               <div class="sidebar-card status-card">
                  ...
                  <div class="sidebar-meta-row"><span class="meta-label">Fingerprint:</span><span class="meta-value code-font">fc2ac686</span></div>
               </div>
               ...
               <div class="sidebar-card review-queue-card" id="governance-review-note">
                  ...
                  <textarea class="review-queue-text" readonly>Please review this LEAP KPI evidence file.&#10;&#10;KPI: Specific Catalyst Cost ($/ton)&#10;KPI ID: KPI-FC2AC68686&#10;Accountable owner: Finance Data Owner&#10;Consulted SME: Finance BI Team&#10;Source: tsql_kpi.tsql&#10;Line: 1&#10;&#10;Review questions:&#10;- Does the business meaning match how the KPI is used?&#10;- Does the formula reflect the approved business rule?&#10;- Are the source fields, filters, and reporting period correct?&#10;- Should this KPI be marked Validated or Needs Review?</textarea>
                  <a id="open-email-draft-btn" class="sidebar-btn btn-secondary" href="mailto:?subject=LEAP+KPI+review+requested%3A+Specific+Catalyst+Cost+%28%24%2Fton%29&body=Please+review+this+LEAP+KPI+evidence+file.%0A%0AKPI%3A+Specific+Catalyst+Cost+%28%24%2Fton%29%0AKPI+ID%3A+KPI-FC2AC68686%0AAccountable+owner%3A+Finance+Data+Owner%0AConsulted+SME%3A+Finance+BI+Team%0ASource%3A+tsql_kpi.tsql%0ALine%3A+1%0A%0AReview+questions%3A%0A-+Does+the+business+meaning+match+how+the+KPI+is+used%3F%0A-+Does+the+formula+reflect+the+approved+business+rule%3F%0A-+Are+the+source+fields%2C+filters%2C+and+reporting+period+correct%3F%0A-+Should+this+KPI+be+marked+Validated+or+Needs+Review%3F">Open Email Draft</a>
               ...
               <div class="sidebar-card raci-card">
                  ...
                  <div class="sidebar-meta-row">
                     ...
                     <span class="meta-value">Finance Data Engineering Team</span>
                  </div>
                  <div class="sidebar-meta-row">
                     <span class="meta-label">Accountable:</span>
                     <span class="meta-value">Finance Data Owner</span>
                  </div>
                  <div class="sidebar-meta-row">
                     <span class="meta-label">Consulted:</span>
                     <span class="meta-value">Finance BI Team</span>
                  </div>
                  <div class="sidebar-meta-row">
                     <span class="meta-label">Informed:</span>
                     <span class="meta-value">CFO Office</span>
                  </div>
               </div>
               ...
               <div class="sidebar-card compact-card">
                  ...
                  <div class="sidebar-meta-row"><span class="meta-label">Type:</span><span class="meta-value">TSQL + Static Scan</span></div>
...
.. raw:: html
   ...
   <div class="formula-panel" style="background-color: #1E1E2E !important; color: #CDD6F4 !important;">
      <pre class="font-mono" style="background-color: transparent !important; color: #CDD6F4 !important;">-- KPI: Specific Catalyst Cost ($/ton)
-- Formula: \mathrm{Catalyst\,Cost\,per\,Ton} = \frac{\mathrm{Catalyst\,Cost}}{\mathrm{Product\,Tons}}

-- T-SQL example KPI calculation
SELECT CAST(catalyst_cost / NULLIF(product_tons, 0) AS DECIMAL(18,6)) AS kpi_specific_catalyst_cost;</pre>
   </div>
