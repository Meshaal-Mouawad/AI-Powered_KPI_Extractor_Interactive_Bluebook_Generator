      ...
      <header class="leap-exec-bar">
         <div class="leap-exec-inner">
            ...
            <div style="display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
               ...
               <div class="growth-badge">ABAP</div>
            </div>
         </div>
      </header>
            ...
            <div class="stack right-rail">
               <section class="dossier-card business-reading-card">
                  ...
                  <div class="semantic-grid">
                     <div class="semantic-item">
                        ...
                        <div style="font-size:14px; line-height:1.6;">SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;Polymer Melt Flow Index (MFI) Variance&quot; in the scanned source.</div>
                     </div>
                     <div class="semantic-item">
               ...
               <section class="dossier-card system-identifier-card">
                  ...
                  <div class="action-row">
                     ...
                     <a href="vscode://file/Users/meshaalmouawad/AI-Powered_KPI_Extractor_Interactive_Bluebook_Generator/sample_project/abap_kpi.abap:1" class="action-btn">VS Code</a>
                     <a href="pycharm://open?file=/Users/meshaalmouawad/AI-Powered_KPI_Extractor_Interactive_Bluebook_Generator/sample_project/abap_kpi.abap&line=1" class="action-btn">PyCharm</a>
                     
                     <a href="/edit?kpi=Polymer%20Melt%20Flow%20Index%20%28MFI%29%20Variance" target="_blank" class="action-btn action-btn-primary">Edit Dossier</a>
                  ...
                  <div class="formula-panel">
                     ...
                     <div class="leap-annotated-formula-wrapper leap-annotated-equation" data-perspective="business">
                        ...
                        <div class="leap-formula-node">
                           <span class="leap-math-lbl long-line" data-biz="Polymer Melt Flow Index" data-dev="COLUMN: Polymer Melt Flow Index">Polymer Melt Flow Index</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">Polymer Melt Flow Index</span>
                        </div>
                        
                        <div class="leap-formula-node">
                           <span class="leap-math-lbl" data-biz="Mfi" data-dev="COLUMN: MFI">Mfi</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">MFI</span>
                        </div>
                        
                        <div class="leap-formula-node">
                           <span class="leap-math-lbl" data-biz="Variance" data-dev="COLUMN: Variance">Variance</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">Variance</span>
                        </div>
                        
                     </div>
                     
                     <div class="leap-code-lineage" hidden><div class="leap-code-lineage-title">Developer Lineage Breakdown</div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">1 | * KPI: Polymer Melt Flow Index (MFI) Variance</div><div class="leap-code-lineage-role">Calculation expression: combines source variables used by the formal formula.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">2 | * Formula: \mathrm{MFI\ Variance} = \frac{\sum (x_i - \bar{x})^2}{n}</div><div class="leap-code-lineage-role">Calculation hint: documents the business expression expected inside the KPI implementation.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">3 | DATA: lv_var   TYPE f,</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">4 | gas_recovered_m3 TYPE f VALUE 120.0,</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">5 | total_gas_m3     TYPE f VALUE 450.0,</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">6 | lv_rate          TYPE f.</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">7 | lv_var = 0.0. &quot; placeholder for variance example</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">8 | &quot; Example KPI expression so the formula renders:</div><div class="leap-code-lineage-role">Calculation hint: documents the business expression expected inside the KPI implementation.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">9 | lv_rate = ( gas_recovered_m3 / total_gas_m3 ) * 100.</div><div class="leap-code-lineage-role">Calculation expression: combines source variables used by the formal formula.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">10 | WRITE: / &#x27;MFI Variance (example):&#x27;, lv_var.</div><div class="leap-code-lineage-role">Calculation expression: combines source variables used by the formal formula.</div></div></div>
                     
                     <details class="evidence-inline">
                        <summary>Code Evidence</summary>
                        <pre class="font-mono">   1 | * KPI: Polymer Melt Flow Index (MFI) Variance
   2 | * Formula: \mathrm{MFI\ Variance} = \frac{\sum (x_i - \bar{x})^2}{n}
   3 | DATA: lv_var   TYPE f,
   4 |       gas_recovered_m3 TYPE f VALUE 120.0,
   5 |       total_gas_m3     TYPE f VALUE 450.0,</pre>
                     </details>
                  </div>
               ...
               <section class="dossier-card">
                  ...
                  <div class="literate-step">
                     ...
                     <div style="font-size:14px; line-height:1.6;">SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;Polymer Melt Flow Index (MFI) Variance&quot; in the scanned source. LEAP frames this as an operational evidence signal for enterprise decision-making.</div>
                  </div>
                  <div class="literate-step">
                     <div class="micro-label">Verified Logic Mapping (The Recipe)</div>
                     <div style="font-size:14px; line-height:1.6;"><ol><li>First, LEAP anchors the KPI definition to abap_kpi.abap and classifies the implementation as ABAP evidence.</li><li>Second, it translates the approved business expression (\mathrm{MFI\ Variance} = \frac{\sum (x_i - \bar{x})^2}{n}) into the formal MathJax formula shown above.</li><li>Finally, it preserves the executable code context and code fingerprint so future changes to the KPI logic can be detected.</li></ol></div>
                  </div>
                  <div class="literate-step">
                     <div class="micro-label">Logic Safeguards & Validations (The Answers)</div>
                     <div style="font-size:14px; line-height:1.6;"><div class="walkthrough-proof-list"><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Source Traceability:</strong> Executable evidence is locked to abap_kpi.abap at line 1.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Formula Consistency Check:</strong> The business formula and source evidence share compatible calculation structure based on LEAP&#x27;s static comparison.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Change Detection:</strong> Code Fingerprint 2188863777 records the current implementation so drift can be detected after regeneration.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>RACI Accountability:</strong> Enterprise Data Owner is assigned as accountable owner for rule confirmation and escalation.</div></div></div></div>
                  </div>
                  <div class="literate-step">
                     <div class="micro-label">Executive Sign-off Alignment</div>
                     <div style="font-size:14px; line-height:1.6;">Business rules are aligned to default rule; no path/name governance match (ABAP). RACI Owner: Enterprise Data Owner. Consulted reviewer: Domain Subject Matter Expert. Current status: Extracted for validation.</div>
                  </div>
               </section>
               ...
               <section class="dossier-card">
                  ...
                  <div class="dependency-row">
                     ...
                     <div style="flex:1;">
                        <div style="display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap;">
                           <span class="font-mono" style="font-size:13px;">abap_kpi.abap</span>
               ...
               <section class="dossier-card">
                  ...
                  <div style="display:grid; gap:16px; font-size:14px;">
                     <div>
                        ...
                        <div><p>SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;Polymer Melt Flow Index (MFI) Variance&quot; in the scanned source. No business meaning was inferred beyond the source text.</p></div>
                     </div>
                     <div>
            ...
            <aside class="leap-metadata-sidebar">
               <div class="sidebar-card status-card">
                  ...
                  <div class="sidebar-meta-row"><span class="meta-label">Fingerprint:</span><span class="meta-value code-font">21888637</span></div>
               </div>
               ...
               <div class="sidebar-card raci-card">
                  ...
                  <div class="sidebar-meta-row">
                     ...
                     <span class="meta-value">Data Engineering Team</span>
                  </div>
                  <div class="sidebar-meta-row">
                     <span class="meta-label">Accountable:</span>
                     <span class="meta-value">Enterprise Data Owner</span>
                  </div>
                  <div class="sidebar-meta-row">
                     <span class="meta-label">Consulted:</span>
                     <span class="meta-value">Domain Subject Matter Expert</span>
                  </div>
                  <div class="sidebar-meta-row">
                     <span class="meta-label">Informed:</span>
                     <span class="meta-value">Business Stakeholders</span>
                  </div>
               </div>
               ...
               <div class="sidebar-card compact-card">
                  ...
                  <div class="sidebar-meta-row"><span class="meta-label">Type:</span><span class="meta-value">ABAP + Static Scan</span></div>
...
.. raw:: html
   ...
   <div class="formula-panel" style="background-color: #1E1E2E !important; color: #CDD6F4 !important;">
      <pre class="font-mono" style="background-color: transparent !important; color: #CDD6F4 !important;">* KPI: Polymer Melt Flow Index (MFI) Variance
...
WRITE: / &#39;Flare Gas Recovery Rate (%):&#39;, lv_rate.</pre>
   </div>
