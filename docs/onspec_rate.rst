      ...
      <header class="leap-exec-bar">
         <div class="leap-exec-inner">
            ...
            <div style="display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
               ...
               <div class="growth-badge">SQL</div>
            </div>
         </div>
      </header>
            ...
            <div class="stack right-rail">
               <section class="dossier-card business-reading-card">
                  ...
                  <div class="semantic-grid">
                     <div class="semantic-item">
                        ...
                        <div style="font-size:14px; line-height:1.6;">SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;On-Spec Rate (%)&quot; in the scanned source.</div>
                     </div>
                     <div class="semantic-item">
               ...
               <section class="dossier-card system-identifier-card">
                  ...
                  <div class="action-row">
                     ...
                     <a href="vscode://file/Users/meshaalmouawad/AI-Powered_KPI_Extractor_Interactive_Bluebook_Generator/sample_project/sql_kpi.sql:1" class="action-btn">VS Code</a>
                     <a href="pycharm://open?file=/Users/meshaalmouawad/AI-Powered_KPI_Extractor_Interactive_Bluebook_Generator/sample_project/sql_kpi.sql&line=1" class="action-btn">PyCharm</a>
                     
                     <a href="/edit?kpi=On-Spec%20Rate%20%28%25%29" target="_blank" class="action-btn action-btn-primary">Edit Dossier</a>
                  ...
                  <div class="formula-panel">
                     ...
                     <div class="leap-annotated-formula-wrapper leap-annotated-equation" data-perspective="business">
                        ...
                        <div class="leap-formula-node">
                           <span class="leap-math-lbl" data-biz="Cast" data-dev="COLUMN: CAST">Cast</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">CAST</span>
                        </div>
                        
                        <div class="leap-formula-node">
                           <span class="leap-math-lbl" data-biz="Literal 100.0" data-dev="LITERAL: 100.0">Literal 100.0</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">100.0</span>
                        </div>
                        
                        <div class="leap-formula-node operator-node">
                           <span class="leap-math-lbl" data-biz="Multiplied By" data-dev="OPERATOR: *">Multiplied By</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">×</span>
                        </div>
                        
                        <div class="leap-formula-node">
                           <span class="leap-math-lbl long-line" data-biz="On Spec Batches" data-dev="COLUMN: on_spec_batches">On Spec Batches</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">on_spec_batches</span>
                        </div>
                        ...
                        <div class="leap-formula-node">
                           <span class="leap-math-lbl" data-biz="Total Batches" data-dev="COLUMN: total_batches">Total Batches</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">total_batches</span>
                        </div>
                        
                     </div>
                     
                     <div class="leap-code-lineage" hidden><div class="leap-code-lineage-title">Developer Lineage Breakdown</div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">1 | -- KPI: On-Spec Rate (%)</div><div class="leap-code-lineage-role">KPI marker: tells LEAP this nearby code defines or documents a KPI.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">2 | -- Formula: \mathrm{On\text{-}Spec\,\%} = \frac{\mathrm{On\text{-}Spec\,Batches}}{\mathrm{Total\,Batches}} \times 100</div><div class="leap-code-lineage-role">Calculation hint: documents the business expression expected inside the KPI implementation.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">3 | CREATE VIEW kpi_on_spec_rate AS</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">4 | SELECT</div><div class="leap-code-lineage-role">Query entry point: starts the data-selection logic used to calculate the KPI.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">5 | CAST(100.0 * on_spec_batches / NULLIF(total_batches, 0) AS FLOAT) AS on_spec_percentage</div><div class="leap-code-lineage-role">Output alias: maps this expression to FLOAT in the result set.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">6 | FROM batch_quality_summary;</div><div class="leap-code-lineage-role">Source relation: identifies the table, view, or dataset read by the KPI.</div></div></div>
                     
                     <details class="evidence-inline">
                        <summary>Code Evidence</summary>
                        <pre class="font-mono">   1 | -- KPI: On-Spec Rate (%)
   2 | -- Formula: \mathrm{On\text{-}Spec\,\%} = \frac{\mathrm{On\text{-}Spec\,Batches}}{\mathrm{Total\,Batches}} \times 100
   3 | CREATE VIEW kpi_on_spec_rate AS
   4 | SELECT
   5 |     CAST(100.0 * on_spec_batches / NULLIF(total_batches, 0) AS FLOAT) AS on_spec_percentage</pre>
                     </details>
                  </div>
               ...
               <section class="dossier-card">
                  ...
                  <div class="literate-step">
                     ...
                     <div style="font-size:14px; line-height:1.6;">SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;On-Spec Rate (%)&quot; in the scanned source. LEAP frames this as an operational evidence signal for enterprise decision-making.</div>
                  </div>
                  <div class="literate-step">
                     <div class="micro-label">Verified Logic Mapping (The Recipe)</div>
                     <div style="font-size:14px; line-height:1.6;"><ol><li>First, LEAP anchors the KPI definition to sql_kpi.sql and classifies the implementation as SQL evidence.</li><li>Second, it translates the approved business expression (\mathrm{On\text{-}Spec\,\%} = \frac{\mathrm{On\text{-}Spec\,Batches}}{\mathrm{Total\,Batches}} \times 100) into the formal MathJax formula shown above.</li><li>Finally, it preserves the executable code context and code fingerprint so future changes to the KPI logic can be detected.</li></ol></div>
                  </div>
                  <div class="literate-step">
                     <div class="micro-label">Logic Safeguards & Validations (The Answers)</div>
                     <div style="font-size:14px; line-height:1.6;"><div class="walkthrough-proof-list"><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Zero-Division Guard:</strong> Source logic uses NULLIF so denominator values of zero do not create invalid ratio calculations.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Formula Consistency Check:</strong> The business formula and source evidence share compatible calculation structure based on LEAP&#x27;s static comparison.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Change Detection:</strong> Code Fingerprint d7e955645a records the current implementation so drift can be detected after regeneration.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>RACI Accountability:</strong> Enterprise Data Owner is assigned as accountable owner for rule confirmation and escalation.</div></div></div></div>
                  </div>
                  <div class="literate-step">
                     <div class="micro-label">Executive Sign-off Alignment</div>
                     <div style="font-size:14px; line-height:1.6;">Business rules are aligned to default rule; no path/name governance match (SQL). RACI Owner: Enterprise Data Owner. Consulted reviewer: Domain Subject Matter Expert. Current status: Extracted for validation.</div>
                  </div>
               </section>
               ...
               <section class="dossier-card">
                  ...
                  <div class="dependency-row">
                     ...
                     <div style="flex:1;">
                        <div style="display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap;">
                           <span style="font-size:14px; font-weight:500;">EXPLICIT SOURCE TABLE(S): batch_quality_summary</span>
                  ...
                  <div class="dependency-row">
                     ...
                     <div style="flex:1;">
                        <div style="display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap;">
                           <span class="font-mono" style="font-size:13px;">sql_kpi.sql</span>
               ...
               <section class="dossier-card">
                  ...
                  <div style="display:grid; gap:16px; font-size:14px;">
                     <div>
                        ...
                        <div><p>SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;On-Spec Rate (%)&quot; in the scanned source. No business meaning was inferred beyond the source text.</p></div>
                     </div>
                     <div>
            ...
            <aside class="leap-metadata-sidebar">
               <div class="sidebar-card status-card">
                  ...
                  <div class="sidebar-meta-row"><span class="meta-label">Fingerprint:</span><span class="meta-value code-font">d7e95564</span></div>
               </div>
               ...
               <div class="sidebar-card compact-card">
                  ...
                  <div class="sidebar-meta-row"><span class="meta-label">Type:</span><span class="meta-value">SQL + Static Scan</span></div>
...
.. raw:: html
   ...
   <div class="formula-panel" style="background-color: #1E1E2E !important; color: #CDD6F4 !important;">
      <pre class="font-mono" style="background-color: transparent !important; color: #CDD6F4 !important;">-- KPI: On-Spec Rate (%)
...
FROM batch_quality_summary;</pre>
   </div>
