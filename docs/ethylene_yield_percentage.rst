...
.. raw:: html
   ...
   <table class="kpi-table">
      <tbody>
         <tr>
            <td>Description</td>
            <td><ul><li>The Ethylene Yield Percentage is a key performance indicator that measures the efficiency of a petrochemical plant's steam cracker in converting feedstock into ethylene</li><li>which is a primary product in the petrochemical industry</li></ul></td>
         </tr>
         <tr>
            <td>Objective</td>
            <td><ul><li>The objective of this KPI is to assess how effectively the plant is utilizing its feedstock to produce ethylene</li><li>thereby indicating the operational efficiency of the production process</li></ul></td>
         </tr>
         <tr>
            <td>Formula</td>
            <td>
               <p>The Ethylene Yield Percentage is calculated by taking the amount of ethylene produced and dividing it by the total volume of feedstock used, then multiplying the result by one hundred to express it as a percentage.</p>
         ...
         <tr>
            <td>Used in KPI(s)</td>
            <td><ul><li>This KPI is used in various operational assessments to evaluate production efficiency and to inform decision-making regarding process improvements and resource allocation</li></ul></td>
         </tr>
         <tr>
            <td>Input Measure</td>
            <td><ul><li>The input measures for this KPI include the total volume of feedstock processed in tons and the total amount of ethylene produced in tons</li></ul></td>
         </tr>
         <tr>
            <td>Unit of Measure</td>
            <td>The unit of measure for the Ethylene Yield Percentage is expressed as a percentage.</td>
         </tr>
         <tr>
            <td>Reporting Source</td>
            <td>The reporting source for this KPI typically comes from production data collected during the operational processes of the petrochemical plant.</td>
         </tr>
         <tr>
            <td>Comments</td>
            <td>Monitoring the Ethylene Yield Percentage is crucial for optimizing production processes and ensuring that the plant operates within its desired efficiency parameters.</td>
         </tr>
      </tbody>
   </table>
