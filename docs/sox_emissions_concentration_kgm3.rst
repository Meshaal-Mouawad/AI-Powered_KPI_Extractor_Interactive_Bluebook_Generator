      ...
      <header class="leap-exec-bar">
         <div class="leap-exec-inner">
            ...
            <div style="display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
               ...
               <div class="growth-badge">IEC_ST</div>
            </div>
         </div>
      </header>
            ...
            <div class="stack right-rail">
               <section class="dossier-card business-reading-card">
                  ...
                  <div class="semantic-grid">
                     <div class="semantic-item">
                        ...
                        <div style="font-size:14px; line-height:1.6;">SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;SOx Emissions Concentration (kg/m3)&quot; in the scanned source.</div>
                     </div>
                     <div class="semantic-item">
                  ...
                  <div style="margin-top:16px; padding-top:14px; border-top:1px solid var(--slate-border);">
                     ...
                     <div style="font-size:14px; line-height:1.6;">If this KPI trends up: Usually signals a higher burden, risk, or exception volume that should be reviewed by the accountable owner. If it trends down: Usually signals lower burden or improved control, provided the data capture process has not changed. Owner check: What changed in source data, business process, or KPI logic that explains movement in SOx Emissions Concentration (kg/m3)?</div>
                  </div>
               </section>

               <section class="dossier-card system-identifier-card">
                  <h3 class="leap-card-title" style="margin-bottom:16px;">System Identifier</h3>
                  <div class="card-row"><span class="label">KPI_ID:</span><span class="value font-mono">KPI-712DEA4C40</span></div>
                  <div class="card-row"><span class="label">Name:</span><span class="value">SOx Emissions Concentration (kg/m3)</span></div>
                  <div class="card-row"><span class="label">Owner:</span><span class="value">HSE Data Owner</span></div>
                  ...
                  <div class="action-row">
                     ...
                     <a href="vscode://file/Users/meshaalmouawad/AI-Powered_KPI_Extractor_Interactive_Bluebook_Generator/sample_project/lc_kpi.st:1" class="action-btn">VS Code</a>
                     <a href="pycharm://open?file=/Users/meshaalmouawad/AI-Powered_KPI_Extractor_Interactive_Bluebook_Generator/sample_project/lc_kpi.st&line=1" class="action-btn">PyCharm</a>
                     
                     <a href="/edit?kpi=SOx%20Emissions%20Concentration%20%28kg/m3%29" target="_blank" class="action-btn action-btn-primary">Edit Dossier</a>
               ...
               <section class="dossier-card">
                  ...
                  <div class="formula-panel">
                     ...
                     <div class="leap-business-formula-math" data-raw-formula="15.2"><span class="leap-formula-fallback">15.2</span></div>
                     ...
                     <div class="leap-annotated-formula-wrapper leap-annotated-equation" data-perspective="business">
                        ...
                        <div class="leap-formula-node">
                           <span class="leap-math-lbl" data-biz="Literal 15.2" data-dev="LITERAL: 15.2">Literal 15.2</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">15.2</span>
                        </div>
                        
                     </div>
                     
                     <div class="leap-code-lineage" hidden><div class="leap-code-lineage-title">Developer Lineage Breakdown</div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">1 | // KPI: SOx Emissions Concentration (kg/m3)</div><div class="leap-code-lineage-role">KPI marker: tells LEAP this nearby code defines or documents a KPI.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">2 | VAR</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">3 | soxConc : REAL := 0.0;</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">4 | soxMassFlow : REAL := 0.0;</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">5 | volFlow : REAL := 0.0;</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">6 | END_VAR</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">7 | (* Example structured text placeholder *)</div><div class="leap-code-lineage-role">Calculation expression: combines source variables used by the formal formula.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">8 | soxConc := 15.2; (* pretend this comes from an analyzer tag *)</div><div class="leap-code-lineage-role">Calculation expression: combines source variables used by the formal formula.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">9 | soxMassFlow := 233.4;</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">10 | volFlow := 15.3;</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div></div>
                     
                     <details class="evidence-inline">
                        <summary>Code Evidence</summary>
                        <pre class="font-mono">   1 | // KPI: SOx Emissions Concentration (kg/m3)
   2 | VAR
   3 |     soxConc : REAL := 0.0;
   4 |     soxMassFlow : REAL := 0.0;
   5 |     volFlow : REAL := 0.0;</pre>
                     </details>
                  </div>
               ...
               <section class="dossier-card">
                  ...
                  <div class="literate-step">
                     ...
                     <div style="font-size:14px; line-height:1.6;">SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;SOx Emissions Concentration (kg/m3)&quot; in the scanned source. LEAP frames this as an operational evidence signal for hse decision-making.</div>
                  </div>
                  <div class="literate-step">
                     <div class="micro-label">Verified Logic Mapping (The Recipe)</div>
                     <div style="font-size:14px; line-height:1.6;"><ol><li>First, LEAP anchors the KPI definition to lc_kpi.st and classifies the implementation as IEC_ST evidence.</li><li>Second, it translates the approved business expression (UNDETERMINED: No approved business formula statement found in source comments.) into the formal MathJax formula shown above.</li><li>Finally, it preserves the executable code context and code fingerprint so future changes to the KPI logic can be detected.</li></ol></div>
                  </div>
                  <div class="literate-step">
                     <div class="micro-label">Logic Safeguards & Validations (The Answers)</div>
                     <div style="font-size:14px; line-height:1.6;"><div class="walkthrough-proof-list"><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Source Traceability:</strong> Executable evidence is locked to lc_kpi.st at line 1.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Formula Consistency Check:</strong> The business formula and source evidence share compatible calculation structure based on LEAP&#x27;s static comparison.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Change Detection:</strong> Code Fingerprint 712dea4c40 records the current implementation so drift can be detected after regeneration.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>RACI Accountability:</strong> HSE Data Owner is assigned as accountable owner for rule confirmation and escalation.</div></div></div></div>
                  </div>
                  <div class="literate-step">
                     <div class="micro-label">Executive Sign-off Alignment</div>
                     <div style="font-size:14px; line-height:1.6;">Business rules are aligned to inferred from KPI name: HSE KPI name. RACI Owner: HSE Data Owner. Consulted reviewer: Environmental Compliance Team. Current status: Extracted for validation.</div>
                  </div>
               </section>
               ...
               <section class="dossier-card">
                  ...
                  <div class="dependency-row">
                     ...
                     <div style="flex:1;">
                        <div style="display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap;">
                           <span style="font-size:14px; font-weight:500;">EXPLICIT SOURCE TABLE(S): an</span>
                  ...
                  <div class="dependency-row">
                     ...
                     <div style="flex:1;">
                        <div style="display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap;">
                           <span class="font-mono" style="font-size:13px;">lc_kpi.st</span>
                  ...
                  <div class="dependency-row">
                     ...
                     <div style="flex:1;">
                        <div style="display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap;">
                           <span style="font-size:14px; font-weight:500;">HSE</span>
               ...
               <section class="dossier-card">
                  ...
                  <div style="display:grid; gap:16px; font-size:14px;">
                     <div>
                        ...
                        <div><p>SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;SOx Emissions Concentration (kg/m3)&quot; in the scanned source. No business meaning was inferred beyond the source text.</p></div>
                     </div>
                     <div>
            ...
            <aside class="leap-metadata-sidebar">
               <div class="sidebar-card status-card">
                  ...
                  <div class="sidebar-meta-row"><span class="meta-label">Fingerprint:</span><span class="meta-value code-font">712dea4c</span></div>
               </div>
               ...
               <div class="sidebar-card review-queue-card" id="governance-review-note">
                  ...
                  <textarea class="review-queue-text" readonly>Please review this LEAP KPI evidence file.&#10;&#10;KPI: SOx Emissions Concentration (kg/m3)&#10;KPI ID: KPI-712DEA4C40&#10;Accountable owner: HSE Data Owner&#10;Consulted SME: Environmental Compliance Team&#10;Source: lc_kpi.st&#10;Line: 1&#10;&#10;Review questions:&#10;- Does the business meaning match how the KPI is used?&#10;- Does the formula reflect the approved business rule?&#10;- Are the source fields, filters, and reporting period correct?&#10;- Should this KPI be marked Validated or Needs Review?</textarea>
                  <a id="open-email-draft-btn" class="sidebar-btn btn-secondary" href="mailto:?subject=LEAP+KPI+review+requested%3A+SOx+Emissions+Concentration+%28kg%2Fm3%29&body=Please+review+this+LEAP+KPI+evidence+file.%0A%0AKPI%3A+SOx+Emissions+Concentration+%28kg%2Fm3%29%0AKPI+ID%3A+KPI-712DEA4C40%0AAccountable+owner%3A+HSE+Data+Owner%0AConsulted+SME%3A+Environmental+Compliance+Team%0ASource%3A+lc_kpi.st%0ALine%3A+1%0A%0AReview+questions%3A%0A-+Does+the+business+meaning+match+how+the+KPI+is+used%3F%0A-+Does+the+formula+reflect+the+approved+business+rule%3F%0A-+Are+the+source+fields%2C+filters%2C+and+reporting+period+correct%3F%0A-+Should+this+KPI+be+marked+Validated+or+Needs+Review%3F">Open Email Draft</a>
               ...
               <div class="sidebar-card raci-card">
                  ...
                  <div class="sidebar-meta-row">
                     ...
                     <span class="meta-value">Environmental Data Engineering Team</span>
                  </div>
                  <div class="sidebar-meta-row">
                     <span class="meta-label">Accountable:</span>
                     <span class="meta-value">HSE Data Owner</span>
                  </div>
                  <div class="sidebar-meta-row">
                     <span class="meta-label">Consulted:</span>
                     <span class="meta-value">Environmental Compliance Team</span>
                  </div>
                  <div class="sidebar-meta-row">
                     <span class="meta-label">Informed:</span>
                     <span class="meta-value">HSE Leadership</span>
                  </div>
               </div>
               ...
               <div class="sidebar-card compact-card">
                  ...
                  <div class="sidebar-meta-row"><span class="meta-label">Type:</span><span class="meta-value">IEC_ST + Static Scan</span></div>
...
.. raw:: html
   ...
   <div class="formula-panel" style="background-color: #1E1E2E !important; color: #CDD6F4 !important;">
      <pre class="font-mono" style="background-color: transparent !important; color: #CDD6F4 !important;">// KPI: SOx Emissions Concentration (kg/m3)
VAR
    soxConc : REAL := 0.0;
