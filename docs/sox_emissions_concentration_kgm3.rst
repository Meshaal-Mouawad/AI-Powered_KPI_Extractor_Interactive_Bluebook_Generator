...
.. raw:: html
   ...
   <table class="kpi-table">
      <tbody>
         <tr>
            <td>Description</td>
            <td><ul><li>SOx Emissions Concentration measures the concentration of sulfur oxides in the emissions</li><li>expressed in kilograms per cubic meter</li><li>This KPI is critical for assessing the environmental impact of operations in the oil</li><li>gas</li><li>and petrochemical industries</li></ul></td>
         </tr>
         <tr>
            <td>Objective</td>
            <td><ul><li>The objective of monitoring SOx Emissions Concentration is to ensure compliance with environmental regulations and to minimize the ecological footprint of industrial activities</li></ul></td>
         </tr>
         <tr>
            <td>Formula</td>
            <td>
         ...
         <tr>
            <td>Used in KPI(s)</td>
            <td><ul><li>This KPI is used in various environmental performance indicators to track emissions and ensure adherence to regulatory standards</li></ul></td>
         </tr>
         <tr>
            <td>Input Measure</td>
         ...
         <tr>
            ...
            <td>The data for this KPI is typically sourced from emissions analyzers that continuously monitor and report the concentration of sulfur oxides in the exhaust streams.</td>
         </tr>
         <tr>
            <td>Comments</td>
            <td>Regular monitoring of SOx Emissions Concentration is essential for identifying trends, implementing corrective actions, and improving overall emissions management strategies.</td>
         </tr>
      </tbody>
   </table>
