   ...
   <table class="kpi-table">
      <tbody>
         ...
         <tr>
            <td>Formula</td>
            <td>
               <p>The formula for Specific Catalyst Cost is derived by dividing the total catalyst cost by the total product tons produced, ensuring that the cost is accurately reflected per unit of output.</p>
