      ...
      <header class="leap-exec-bar">
         <div class="leap-exec-inner">
            ...
            <div style="display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
               ...
               <div class="growth-badge">VBNET</div>
            </div>
         </div>
      </header>
               ...
               <section class="dossier-card business-reading-card">
                  ...
                  <div class="semantic-grid">
                     <div class="semantic-item">
                        ...
                        <div style="font-size:14px; line-height:1.6;">SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;Mean Time Between Failures (MTBF)&quot; in the scanned source.</div>
                     </div>
                     <div class="semantic-item">
                  ...
                  <div style="margin-top:16px; padding-top:14px; border-top:1px solid var(--slate-border);">
                     ...
                     <div style="font-size:14px; line-height:1.6;">If this KPI trends up: Usually signals a higher burden, risk, or exception volume that should be reviewed by the accountable owner. If it trends down: Usually signals lower burden or improved control, provided the data capture process has not changed. Owner check: What changed in source data, business process, or KPI logic that explains movement in Mean Time Between Failures (MTBF)?</div>
                  </div>
               </section>

               <section class="dossier-card system-identifier-card">
                  <h3 class="leap-card-title" style="margin-bottom:16px;">System Identifier</h3>
                  <div class="card-row"><span class="label">KPI_ID:</span><span class="value font-mono">KPI-A8A5D05CB1</span></div>
                  <div class="card-row"><span class="label">Name:</span><span class="value">Mean Time Between Failures (MTBF)</span></div>
                  <div class="card-row"><span class="label">Owner:</span><span class="value">Maintenance Data Owner</span></div>
                  ...
                  <div class="action-row">
                     ...
                     <a href="vscode://file/Users/meshaalmouawad/AI-Powered_KPI_Extractor_Interactive_Bluebook_Generator/sample_project/vb_kpi.vb:1" class="action-btn">VS Code</a>
                     <a href="pycharm://open?file=/Users/meshaalmouawad/AI-Powered_KPI_Extractor_Interactive_Bluebook_Generator/sample_project/vb_kpi.vb&line=1" class="action-btn">PyCharm</a>
                     
                     <a href="/edit?kpi=Mean%20Time%20Between%20Failures%20%28MTBF%29" target="_blank" class="action-btn action-btn-primary">Edit Dossier</a>
                  ...
                  <div class="formula-panel">
                     ...
                     <div class="leap-annotated-formula-wrapper leap-annotated-equation" data-perspective="business">
                        ...
                        <div class="leap-formula-node">
                           <span class="leap-math-lbl" data-biz="Operating Hours" data-dev="COLUMN: operatingHours">Operating Hours</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">operatingHours</span>
                        </div>
                        ...
                        <div class="leap-formula-node">
                           <span class="leap-math-lbl long-line" data-biz="Number Of Failures" data-dev="COLUMN: numberOfFailures">Number Of Failures</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">numberOfFailures</span>
                        </div>
                        
                     </div>
                     
                     <div class="leap-code-lineage" hidden><div class="leap-code-lineage-title">Developer Lineage Breakdown</div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">1 | &#x27; KPI: Mean Time Between Failures (MTBF)</div><div class="leap-code-lineage-role">KPI marker: tells LEAP this nearby code defines or documents a KPI.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">2 | &#x27; Formula: \mathrm{MTBF} = \frac{\mathrm{Operating\ Hours}}{\mathrm{Number\ of\ Failures}}</div><div class="leap-code-lineage-role">Calculation hint: documents the business expression expected inside the KPI implementation.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">3 | Public Module KpiDemo</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">4 | Public Function CalcMTBF(operatingHours As Integer, numberOfFailures As Integer) As Double</div><div class="leap-code-lineage-role">KPI function: CalcMTBF is the callable routine that exposes this metric.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">5 | If numberOfFailures = 0 Then</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">6 | Return operatingHours</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">7 | End If</div><div class="leap-code-lineage-role">Scope boundary: closes the KPI package, function, or code block.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">8 | Return operatingHours / numberOfFailures</div><div class="leap-code-lineage-role">Calculation expression: combines source variables used by the formal formula.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">9 | End Function</div><div class="leap-code-lineage-role">Scope boundary: closes the KPI package, function, or code block.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">10 | End Module</div><div class="leap-code-lineage-role">Scope boundary: closes the KPI package, function, or code block.</div></div></div>
                     
                     <details class="evidence-inline">
                        <summary>Code Evidence</summary>
                        <pre class="font-mono">   1 | &#x27; KPI: Mean Time Between Failures (MTBF)
   2 | &#x27; Formula: \mathrm{MTBF} = \frac{\mathrm{Operating\ Hours}}{\mathrm{Number\ of\ Failures}}
   3 | Public Module KpiDemo
   4 |     Public Function CalcMTBF(operatingHours As Integer, numberOfFailures As Integer) As Double
   5 |         If numberOfFailures = 0 Then</pre>
                     </details>
                  </div>
               ...
               <section class="dossier-card">
                  ...
                  <div class="literate-step">
                     ...
                     <div style="font-size:14px; line-height:1.6;">SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;Mean Time Between Failures (MTBF)&quot; in the scanned source. LEAP frames this as an operational evidence signal for maintenance decision-making.</div>
                  </div>
                  <div class="literate-step">
                     <div class="micro-label">Verified Logic Mapping (The Recipe)</div>
                     <div style="font-size:14px; line-height:1.6;"><ol><li>First, LEAP anchors the KPI definition to vb_kpi.vb and classifies the implementation as VBNET evidence.</li><li>Second, it translates the approved business expression (\mathrm{MTBF} = \frac{\mathrm{Operating\ Hours}}{\mathrm{Number\ of\ Failures}}) into the formal MathJax formula shown above.</li><li>Finally, it preserves the executable code context and code fingerprint so future changes to the KPI logic can be detected.</li></ol></div>
                  </div>
                  <div class="literate-step">
                     <div class="micro-label">Logic Safeguards & Validations (The Answers)</div>
                     <div style="font-size:14px; line-height:1.6;"><div class="walkthrough-proof-list"><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Source Traceability:</strong> Executable evidence is locked to vb_kpi.vb at line 1.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Formula Consistency Check:</strong> The business formula and source evidence share compatible calculation structure based on LEAP&#x27;s static comparison.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Change Detection:</strong> Code Fingerprint a8a5d05cb1 records the current implementation so drift can be detected after regeneration.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>RACI Accountability:</strong> Maintenance Data Owner is assigned as accountable owner for rule confirmation and escalation.</div></div></div></div>
                  </div>
                  <div class="literate-step">
                     <div class="micro-label">Executive Sign-off Alignment</div>
                     <div style="font-size:14px; line-height:1.6;">Business rules are aligned to inferred from KPI name: Maintenance KPI name. RACI Owner: Maintenance Data Owner. Consulted reviewer: Reliability Engineering Team. Current status: Extracted for validation.</div>
                  </div>
               </section>
               ...
               <section class="dossier-card">
                  ...
                  <div class="dependency-row">
                     ...
                     <div style="flex:1;">
                        <div style="display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap;">
                           <span class="font-mono" style="font-size:13px;">vb_kpi.vb</span>
               ...
               <section class="dossier-card">
                  ...
                  <div style="display:grid; gap:16px; font-size:14px;">
                     <div>
                        ...
                        <div><p>SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;Mean Time Between Failures (MTBF)&quot; in the scanned source. No business meaning was inferred beyond the source text.</p></div>
                     </div>
                     <div>
            ...
            <aside class="leap-metadata-sidebar">
               <div class="sidebar-card status-card">
                  ...
                  <div class="sidebar-meta-row"><span class="meta-label">Fingerprint:</span><span class="meta-value code-font">a8a5d05c</span></div>
               </div>
               ...
               <div class="sidebar-card review-queue-card" id="governance-review-note">
                  ...
                  <textarea class="review-queue-text" readonly>Please review this LEAP KPI evidence file.&#10;&#10;KPI: Mean Time Between Failures (MTBF)&#10;KPI ID: KPI-A8A5D05CB1&#10;Accountable owner: Maintenance Data Owner&#10;Consulted SME: Reliability Engineering Team&#10;Source: vb_kpi.vb&#10;Line: 1&#10;&#10;Review questions:&#10;- Does the business meaning match how the KPI is used?&#10;- Does the formula reflect the approved business rule?&#10;- Are the source fields, filters, and reporting period correct?&#10;- Should this KPI be marked Validated or Needs Review?</textarea>
                  <a id="open-email-draft-btn" class="sidebar-btn btn-secondary" href="mailto:?subject=LEAP+KPI+review+requested%3A+Mean+Time+Between+Failures+%28MTBF%29&body=Please+review+this+LEAP+KPI+evidence+file.%0A%0AKPI%3A+Mean+Time+Between+Failures+%28MTBF%29%0AKPI+ID%3A+KPI-A8A5D05CB1%0AAccountable+owner%3A+Maintenance+Data+Owner%0AConsulted+SME%3A+Reliability+Engineering+Team%0ASource%3A+vb_kpi.vb%0ALine%3A+1%0A%0AReview+questions%3A%0A-+Does+the+business+meaning+match+how+the+KPI+is+used%3F%0A-+Does+the+formula+reflect+the+approved+business+rule%3F%0A-+Are+the+source+fields%2C+filters%2C+and+reporting+period+correct%3F%0A-+Should+this+KPI+be+marked+Validated+or+Needs+Review%3F">Open Email Draft</a>
               ...
               <div class="sidebar-card raci-card">
                  ...
                  <div class="sidebar-meta-row">
                     ...
                     <span class="meta-value">Reliability Data Engineering Team</span>
                  </div>
                  <div class="sidebar-meta-row">
                     <span class="meta-label">Accountable:</span>
                     <span class="meta-value">Maintenance Data Owner</span>
                  </div>
                  <div class="sidebar-meta-row">
                     <span class="meta-label">Consulted:</span>
                     <span class="meta-value">Reliability Engineering Team</span>
                  </div>
                  <div class="sidebar-meta-row">
                     <span class="meta-label">Informed:</span>
                     <span class="meta-value">Maintenance Leadership</span>
                  </div>
               </div>
               ...
               <div class="sidebar-card compact-card">
                  ...
                  <div class="sidebar-meta-row"><span class="meta-label">Type:</span><span class="meta-value">VBNET + Static Scan</span></div>
...
.. raw:: html
   ...
   <div class="formula-panel" style="background-color: #1E1E2E !important; color: #CDD6F4 !important;">
      <pre class="font-mono" style="background-color: transparent !important; color: #CDD6F4 !important;">&#39; KPI: Mean Time Between Failures (MTBF)
