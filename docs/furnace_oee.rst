...
.. raw:: html
   ...
   <table class="kpi-table">
      <tbody>
         <tr>
            <td>Description</td>
            <td><ul><li>Furnace OEE % measures the overall equipment effectiveness of the furnace</li><li>reflecting its performance in terms of availability</li><li>performance efficiency</li><li>and quality output</li><li>Overall Equipment Effectiveness combines Availability</li><li>Performance</li><li>and Quality into a single effectiveness score</li></ul></td>
         </tr>
         <tr>
            <td>Objective</td>
            <td><ul><li>The objective of monitoring Furnace OEE % is to identify areas for improvement in furnace operations</li><li>enhance productivity</li><li>and minimize downtime</li><li>Increase effective productive time by reducing downtime</li><li>speed losses</li><li>and quality losses</li></ul></td>
         </tr>
         <tr>
            <td>Formula</td>
            <td>
               <p>Furnace OEE % is calculated by assessing the availability of the furnace, which is set at a benchmark of 92%.</p>
         ...
         <tr>
            <td>Used in KPI(s)</td>
            <td><ul><li>Furnace OEE % is utilized in key performance indicators related to operational efficiency and productivity within the furnace operations</li></ul></td>
         </tr>
         <tr>
            <td>Input Measure</td>
            <td><ul><li>The primary input measure for Furnace OEE % is the availability of the furnace</li><li>which indicates the proportion of time the furnace is operational compared to the total scheduled time</li><li>Availability</li><li>performance</li><li>and quality factors calculated for the asset or line</li></ul></td>
         </tr>
         <tr>
            <td>Unit of Measure</td>
            <td>The unit of measure for Furnace OEE % is expressed as a percentage.</td>
         </tr>
         <tr>
            <td>Reporting Source</td>
            <td>The reporting source for Furnace OEE % is derived from operational data collected from the furnace monitoring systems.</td>
         </tr>
         <tr>
            <td>Comments</td>
            <td>A high Furnace OEE % indicates effective utilization of the furnace, while a low percentage may highlight issues such as equipment failures or inefficiencies in the production process.</td>
         </tr>
      </tbody>
   </table>
