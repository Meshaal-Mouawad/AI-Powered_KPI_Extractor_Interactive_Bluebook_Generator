...
.. raw:: html
   ...
   <div style="margin-bottom: 1.5em; display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
      ...
      <a href="/edit?kpi=KPI084" target="_blank" class="btn btn-edit">Edit</a>
   </div>
   ...
   <table class="kpi-table">
      <tbody>
         <tr>
            <td>Description</td>
            <td><ul><li>KPI084 is a key performance indicator used to assess process efficiency and operational performance</li></ul></td>
         </tr>
         <tr>
            <td>Objective</td>
            <td><ul><li>The objective of KPI084 is to provide a clear measure that supports monitoring</li><li>decision making</li><li>and continuous improvement</li></ul></td>
         </tr>
         <tr>
            <td>Formula</td>
            <td>
               <p>Calculated directly from the inputs found in the code implementation.</p>
               <div class="math-equation">$$ \mathit{Dim\,Normalized\,Cost\,As\,Double} = \frac{\mathit{Fixed\,Cash\,Cost}}{\mathit{Turnaround\,Events}} $$</div>
            </td>
         </tr>
...
.. admonition:: Code Context
   ...
   .. code-block:: vbnet
      ...
      ' KPI084: $ Manufacturing Fixed Cash Cost Normalized (to TA)
   Dim normalizedCost As Double = FixedCashCost / TurnaroundEvents
   Console.WriteLine("Normalized Fixed Cash Cost: " & normalizedCost)