         ...
         <div class="leap-exec-inner">
            ...
            <div style="display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
               <div style="display:flex; align-items:center; gap:8px;">
                  ...
                  <span style="font-size:14px; font-weight:600; color:var(--success);">95%</span>
               </div>
               <div class="growth-badge">PLSQL</div>
            </div>
         </div>
      </header>
               ...
               <section class="dossier-card business-reading-card">
                  ...
                  <div class="semantic-grid">
                     <div class="semantic-item">
                        ...
                        <div style="font-size:14px; line-height:1.6;">SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;Yield Percentage (%)&quot; in the scanned source.</div>
                     </div>
                     <div class="semantic-item">
                  ...
                  <div style="margin-top:16px; padding-top:14px; border-top:1px solid var(--slate-border);">
                     ...
                     <div style="font-size:14px; line-height:1.6;">If this KPI trends up: Usually signals better operating performance, assuming the denominator and period filters are unchanged. If it trends down: Usually signals weaker performance or a possible data-quality issue that should be investigated. Owner check: What changed in source data, business process, or KPI logic that explains movement in Yield Percentage (%)?</div>
                  </div>
               </section>

               <section class="dossier-card system-identifier-card">
                  <h3 class="leap-card-title" style="margin-bottom:16px;">System Identifier</h3>
                  <div class="card-row"><span class="label">KPI_ID:</span><span class="value font-mono">KPI-058E0AE1DF</span></div>
                  <div class="card-row"><span class="label">Name:</span><span class="value">Yield Percentage (%)</span></div>
                  <div class="card-row"><span class="label">Owner:</span><span class="value">Operations Data Owner</span></div>
                  ...
                  <div class="action-row">
                     ...
                     <a href="vscode://file/Users/meshaalmouawad/AI-Powered_KPI_Extractor_Interactive_Bluebook_Generator/sample_project/plsql_kpi.pks:1" class="action-btn">VS Code</a>
                     <a href="pycharm://open?file=/Users/meshaalmouawad/AI-Powered_KPI_Extractor_Interactive_Bluebook_Generator/sample_project/plsql_kpi.pks&line=1" class="action-btn">PyCharm</a>
                     
                     <a href="/edit?kpi=Yield%20Percentage%20%28%25%29" target="_blank" class="action-btn action-btn-primary">Edit Dossier</a>
                     <a href="#governance-review-note" class="action-btn">Review Evidence</a>
                  </div>
               </section>
                  ...
                  <div class="formula-panel">
                     ...
                     <div class="leap-annotated-formula-wrapper leap-annotated-equation" data-perspective="business">
                        ...
                        <div class="leap-formula-node">
                           <span class="leap-math-lbl long-line" data-biz="Desired Product" data-dev="COLUMN: desired_product">Desired Product</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">desired_product</span>
                        </div>
                        
                        <div class="leap-formula-node operator-node">
                           <span class="leap-math-lbl" data-biz="Divided By" data-dev="OPERATOR: /">Divided By</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">÷</span>
                        </div>
                        
                        <div class="leap-formula-node">
                           <span class="leap-math-lbl" data-biz="Total Input" data-dev="COLUMN: total_input">Total Input</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">total_input</span>
                        </div>
                        
                        <div class="leap-formula-node operator-node">
                           <span class="leap-math-lbl" data-biz="Scaled by 100" data-dev="LITERAL: * 100">Scaled by 100</span>
                           <div class="leap-math-pointer"></div>
                           <span class="leap-math-render">× 100</span>
                        </div>
                        
                     </div>
                     
                     <div class="leap-code-lineage" hidden><div class="leap-code-lineage-title">Developer Lineage Breakdown</div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">1 | -- KPI: Yield Percentage (%)</div><div class="leap-code-lineage-role">KPI marker: tells LEAP this nearby code defines or documents a KPI.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">2 | -- Formula: \mathrm{Yield\,\%} = \frac{\mathrm{Desired\,Product}}{\mathrm{Total\,Input}} \times 100</div><div class="leap-code-lineage-role">Calculation hint: documents the business expression expected inside the KPI implementation.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">3 | CREATE OR REPLACE PACKAGE kpi_pkg AS</div><div class="leap-code-lineage-role">Package boundary: declares the interface where this KPI routine is published.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">4 | FUNCTION yield_pct(desired_product NUMBER, total_input NUMBER) RETURN NUMBER;</div><div class="leap-code-lineage-role">KPI function: yield_pct exposes this metric; RETURN NUMBER declares the KPI result as numeric output.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">5 | END kpi_pkg;</div><div class="leap-code-lineage-role">Scope boundary: closes the KPI package, function, or code block.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">6 | /</div><div class="leap-code-lineage-role">Execution delimiter: separates or submits the database package statement.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">7 | CREATE OR REPLACE PACKAGE BODY kpi_pkg AS</div><div class="leap-code-lineage-role">Package boundary: declares the interface where this KPI routine is published.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">8 | FUNCTION yield_pct(desired_product NUMBER, total_input NUMBER) RETURN NUMBER IS</div><div class="leap-code-lineage-role">KPI function: yield_pct exposes this metric; RETURN NUMBER declares the KPI result as numeric output.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">9 | BEGIN</div><div class="leap-code-lineage-role">Source context: supports the KPI definition or execution boundary.</div></div><div class="leap-code-lineage-row"><div class="leap-code-lineage-code">10 | IF total_input = 0 THEN RETURN 0; END IF;</div><div class="leap-code-lineage-role">Scope boundary: closes the KPI package, function, or code block.</div></div></div>
                     
                     <details class="evidence-inline">
                        <summary>Code Evidence</summary>
                        <pre class="font-mono">   1 | -- KPI: Yield Percentage (%)
   2 | -- Formula: \mathrm{Yield\,\%} = \frac{\mathrm{Desired\,Product}}{\mathrm{Total\,Input}} \times 100
   3 | 
   4 | CREATE OR REPLACE PACKAGE kpi_pkg AS
   5 |   FUNCTION yield_pct(desired_product NUMBER, total_input NUMBER) RETURN NUMBER;</pre>
                     </details>
                  </div>
               ...
               <section class="dossier-card">
                  ...
                  <div class="literate-step">
                     ...
                     <div style="font-size:14px; line-height:1.6;">SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;Yield Percentage (%)&quot; in the scanned source. LEAP frames this as an operational evidence signal for operations decision-making.</div>
                  </div>
                  <div class="literate-step">
                     <div class="micro-label">Verified Logic Mapping (The Recipe)</div>
                     <div style="font-size:14px; line-height:1.6;"><ol><li>First, LEAP anchors the KPI definition to plsql_kpi.pks and classifies the implementation as PLSQL evidence.</li><li>Second, it translates the approved business expression (\mathrm{Yield\,\%} = \frac{\mathrm{Desired\,Product}}{\mathrm{Total\,Input}} \times 100) into the formal MathJax formula shown above.</li><li>Finally, it preserves the executable code context and code fingerprint so future changes to the KPI logic can be detected.</li></ol></div>
                  </div>
                  <div class="literate-step">
                     <div class="micro-label">Logic Safeguards & Validations (The Answers)</div>
                     <div style="font-size:14px; line-height:1.6;"><div class="walkthrough-proof-list"><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Source Traceability:</strong> Executable evidence is locked to plsql_kpi.pks at line 1.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Formula Consistency Check:</strong> The business formula and source evidence share compatible calculation structure based on LEAP&#x27;s static comparison.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>Change Detection:</strong> Code Fingerprint 058e0ae1df records the current implementation so drift can be detected after regeneration.</div></div><div class="walkthrough-proof-item"><span class="walkthrough-check">OK</span><div><strong>RACI Accountability:</strong> Operations Data Owner is assigned as accountable owner for rule confirmation and escalation.</div></div></div></div>
                  </div>
                  <div class="literate-step">
                     <div class="micro-label">Executive Sign-off Alignment</div>
                     <div style="font-size:14px; line-height:1.6;">Business rules are aligned to inferred from KPI name: Operations KPI name. RACI Owner: Operations Data Owner. Consulted reviewer: Process Engineering Team. Current status: Extracted for validation.</div>
                  </div>
               </section>

               <section class="dossier-card">
                  <h3 class="leap-card-title" style="margin-bottom:16px;">Source Provenance</h3>
                  ...
                  <div class="dependency-row">
                     ...
                     <div style="flex:1;">
                        <div style="display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap;">
                           <span class="font-mono" style="font-size:13px;">plsql_kpi.pks</span>
                           <span class="source-chip" style="color:var(--warning);">SOURCE</span>
                        </div>
                        <p style="margin:4px 0 0; color:var(--slate-muted); font-size:12px;">Line 1 • Sql Comment</p>
                     </div>
                  </div>
                  <div class="dependency-row">
                     <div class="tiny-dot"></div>
                     <div style="flex:1;">
                        <div style="display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap;">
                           <span style="font-size:14px; font-weight:500;">Operations</span>
               ...
               <section class="dossier-card">
                  ...
                  <div style="display:grid; gap:16px; font-size:14px;">
                     <div>
                        ...
                        <div><p>SOURCE-VERIFIED CANDIDATE: LEAP detected calculation logic named &quot;Yield Percentage (%)&quot; in the scanned source. No business meaning was inferred beyond the source text.</p></div>
                     </div>
                     <div>
            ...
            <aside class="leap-metadata-sidebar">
               <div class="sidebar-card status-card">
                  ...
                  <div class="sidebar-meta-row"><span class="meta-label">Confidence:</span><span class="meta-value">95%</span></div>
                  <div class="sidebar-meta-row"><span class="meta-label">Fingerprint:</span><span class="meta-value code-font">058e0ae1</span></div>
               </div>
               ...
               <div class="sidebar-card review-queue-card" id="governance-review-note">
                  ...
                  <textarea class="review-queue-text" readonly>Please review this LEAP KPI evidence file.&#10;&#10;KPI: Yield Percentage (%)&#10;KPI ID: KPI-058E0AE1DF&#10;Accountable owner: Operations Data Owner&#10;Consulted SME: Process Engineering Team&#10;Source: plsql_kpi.pks&#10;Line: 1&#10;&#10;Review questions:&#10;- Does the business meaning match how the KPI is used?&#10;- Does the formula reflect the approved business rule?&#10;- Are the source fields, filters, and reporting period correct?&#10;- Should this KPI be marked Validated or Needs Review?</textarea>
                  <a id="open-email-draft-btn" class="sidebar-btn btn-secondary" href="mailto:?subject=LEAP+KPI+review+requested%3A+Yield+Percentage+%28%25%29&body=Please+review+this+LEAP+KPI+evidence+file.%0A%0AKPI%3A+Yield+Percentage+%28%25%29%0AKPI+ID%3A+KPI-058E0AE1DF%0AAccountable+owner%3A+Operations+Data+Owner%0AConsulted+SME%3A+Process+Engineering+Team%0ASource%3A+plsql_kpi.pks%0ALine%3A+1%0A%0AReview+questions%3A%0A-+Does+the+business+meaning+match+how+the+KPI+is+used%3F%0A-+Does+the+formula+reflect+the+approved+business+rule%3F%0A-+Are+the+source+fields%2C+filters%2C+and+reporting+period+correct%3F%0A-+Should+this+KPI+be+marked+Validated+or+Needs+Review%3F">Open Email Draft</a>
                  <button class="sidebar-btn btn-secondary" type="button" onclick="copyLeapReviewText(this)">Copy Review Text</button>
               </div>

               <div class="sidebar-card raci-card">
                  <h3>Governance Scope</h3>
                  <div class="sidebar-meta-row">
                     <span class="meta-label">Responsible:</span>
                     <span class="meta-value">Operations Data Engineering Team</span>
                  </div>
                  <div class="sidebar-meta-row">
                     <span class="meta-label">Accountable:</span>
                     <span class="meta-value">Operations Data Owner</span>
                  </div>
                  <div class="sidebar-meta-row">
                     <span class="meta-label">Consulted:</span>
                     <span class="meta-value">Process Engineering Team</span>
                  </div>
                  <div class="sidebar-meta-row">
                     <span class="meta-label">Informed:</span>
                     <span class="meta-value">Plant Management</span>
                  </div>
               </div>

               <div class="sidebar-card action-card">
                  <h3>Operational Actions</h3>
                  <button class="sidebar-btn btn-primary" type="button" onclick="window.print()">Export Certified Bluebook</button>
                  <a class="sidebar-btn btn-secondary" href="discovery_report">Open Discovery Report</a>
                  <a class="sidebar-btn btn-secondary" href="raci_directory">Open RACI Directory</a>
               </div>
               
               <div class="sidebar-card compact-card">
                  <h3>Extraction Method</h3>
                  <div class="sidebar-meta-row"><span class="meta-label">Type:</span><span class="meta-value">PLSQL + Static Scan</span></div>
...
.. raw:: html
   ...
   <div class="formula-panel" style="background-color: #1E1E2E !important; color: #CDD6F4 !important;">
      <pre class="font-mono" style="background-color: transparent !important; color: #CDD6F4 !important;">-- KPI: Yield Percentage (%)
